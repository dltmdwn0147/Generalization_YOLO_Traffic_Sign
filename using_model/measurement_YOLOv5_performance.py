...
# 모델 로드
model = YOLO(r'C:\Users\이승주\Desktop\YOLOv5\All(ACD)(4,3,3)\weights\best.pt')
...
# 검증 수행
data = r'C:\Users\이승주\Desktop\YOLO_DATA_SET\deknv\data.yaml'
metrics = model.val(device = device, project = save_dir, name = name)
# 메소드 호출
